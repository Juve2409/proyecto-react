...
{ id: 4, texto: "tareas pendientes ", completada: false }
];
...
// ===== DEMOSTRACIÓN =====
mostrarTareas();
const tarea4 = agregarTarea("Revisar documentación");
mostrarTareas();    
completarTarea(tarea4.id);
mostrarTareas();
eliminarTarea(2);
mostrarTareas();
console.log("Tareas pendientes:", obtenerPendientes());
obtenerEstadisticas();  
